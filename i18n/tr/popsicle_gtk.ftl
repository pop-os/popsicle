app-title = USB Disk Görüntüsü Yazdırma

# Images View
cannot-select-directories = Klasör seçilemez
check-label = Kontrol et
choose-image-button = Disk görüntüsü seç
generating-checksum = Disk görüntüsü özeti oluşturuluyor
hash-label = Özet Kodu:
...
image-view-title = Disk görüntüsünü seçin
...
devices-view-title = Bellek aygıtlarını seçin
...
# Summary View
flashing-completed = Yazdırma işlemi tamamlandı.
flashing-completed-with-errors = Yazdırma işlemi hatalarla tamamlandı.
flash-again = Tekrar yazdır

# Error View
critical-error = Kritik bir hata oluştu.
...
no-value-found = Değer bulunamadı.
